    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="mx-auto max-w-6xl px-4 py-14 relative z-20">
          ...
          {[
            {
              ...
              badge: "Dịch vụ Phổ thông",
              title: "Kiểm Tra Tổng Quát Xe",
              desc: "Kiểm tra toàn diện xe, hệ thống điện, phanh, lốp, cập nhật phần mềm (nếu có) theo chuẩn hãng.",
              price: "300.000",
            ...
            },
            {
              ...
              badge: "Dịch vụ Đặc thù EV",
              title: "Bảo Dưỡng Hệ Thống Làm Mát Pin",
              desc: "Kiểm tra hệ thống làm mátx pin, đảm bảo nhiệt độ hoạt động tối ưu và an toàn cho pin cao áp.",
              price: "350.000",
              border: "border-primary",
              bg: "bg-primary",
              badgeBg: "bg-primary/10",
            ...
            },
            {
              ...
              badge: "Dịch vụ Hỗ trợ",
              title: "Thay Lọc Gió Cabin (Điều Hòa)",
              desc: "Giúp không khí trong xe luôn sạch, loại bỏ bụi mịn và mùi khó chịu, tăng hiệu quả làm mát.",
              price: "200.000",
              border: "border-primary",
            ...
            <div
              key={i}
              className={`bg-card backdrop-blur-sm rounded-2xl p-8 shadow-2xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-105 border-2 border-card hover:border-primary/30`}
            >
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-16 h-16 ${service.bg} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg transition-all duration-500 hover:scale-110 hover:rotate-6`}
                >
                  <svg
                ...
                <div>
                  <span
                    className={`inline-block ${service.badgeBg} ${service.badgeText} text-xs font-bold px-3 py-1 rounded-full mb-2`}
                  >
                    {service.badge}
                  </span>
              ...
              <div className="pt-4 border-t border-border">
                ...
                <p className={`text-3xl font-bold ${service.priceColor}`}>
                  {service.price} <span className="text-lg">VNĐ</span>
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="mt-8 text-center">
          <div className="bg-card backdrop-blur-sm rounded-2xl p-10 shadow-2xl max-w-3xl mx-auto border-2 border-card">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-primary-foreground font-bold rounded-xl shadow-lg hover:shadow-xl transition-smooth hover:-translate-y-1 hover:bg-primary/90"
              >
                <svg
              ...
              <a
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-card text-foreground font-bold rounded-xl shadow-lg hover:shadow-xl transition-smooth hover:-translate-y-1 border-2 border-border hover:bg-secondary/50"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
